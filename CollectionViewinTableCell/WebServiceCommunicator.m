...
-(void)fetchForcastDataForCity:(id)cityNameOrCLLocation andCompletionHandler:(void (^)(City *, NSError *))completionHandler
{
    ...
    if ([cityNameOrCLLocation isKindOfClass:[NSString class]]) { //using city name
    ...
    else if ([cityNameOrCLLocation isKindOfClass:[CLLocation class]]) { //using location
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse * _Nullable response, NSData * _Nullable data, NSError * _Nullable connectionError) {
        ...
        if (data && !connectionError) {
            ...
            if (dataDic) {
                ...
                else
                {
                    ...
                    NSError *error = [NSError errorWithDomain:@"CollectionViewinTableCell" code:[responseCode intValue] userInfo:details];
        ...
        else
        {
            ...
            NSError *error = [NSError errorWithDomain:@"CollectionViewinTableCell" code:-50 userInfo:details];
